...
`run_x5_frame.py` is the deployment smoke path when DNG decoding occurs elsewhere. It preserves the same runtime input contract and produces inspectable artifacts, but its timing report is diagnostic rather than a quality verdict.
